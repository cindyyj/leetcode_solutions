class Twitter:
    # 主要存储两个变量，一个 dict 记录某用户 id(key:int) 和其关注者 (value:list)
...
# 作者：LotusPanda
# 链接：https://leetcode-cn.com/problems/design-twitter/solution/xiong-mao-shua-ti-python3-ha-xi-si-lu-yi-dong-by-l/
# 来源：力扣（LeetCode）
